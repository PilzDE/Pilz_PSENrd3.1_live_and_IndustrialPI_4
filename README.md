...
+ with ctrl key and hold right mouse button, a menu with unicode fonts will appear.
+ navigate with the mouse to your desired font size. (Hold down the ctrl key and the right mouse button the whole time)
