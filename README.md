...
+ To connect a laptop to your IndustrialPI 4. Connect the laptop to the right Ethernet port on the IndustrialPI 4 using an Ethernet cable. Open your browser and enter  
