...
<div style="display: flex; flex-direction: column; align-items: center;">
        <img src="/img/Pilz_IndustrialPI_4_and_PSENrd_3_1_live.png" alt="Structure of the application (schematic)" width="800">
    </a><br/>
</div>
...
```
+ Please write the following settings in this new file:<br/> (The following settings are an example, please use your IP addresses)
```
auto wlan0
...
+ To connect a laptop to your IndustrialPI 4. Connect the laptop to the right Ethernet port on the IndustrialPI 4 using an Ethernet cable. Open your browser and enter<br/> 
